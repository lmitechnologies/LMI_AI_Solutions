...
def train_padim(
    ...
    padim.padim_train(
        dataloader,
        c=cprime,
        net_type=config["name"],
        layer_names=layerconfig,
        is_plot=False,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--imsz",
        default="224,224",
        help="comma separated image dimension: w,h. default=224,224",
    )
    parser.add_argument(
        "--n",
        default=200,
        type=int,
        help="the number of vectors to randomly draw, default=200",
    )
