...
def processContours(self, heatMap, err_dist, color_threshold, size_fail, size_ignore=None):
    ...
    _, heat_map_binary = cv2.threshold(
        heatmap_gray_invert, color_threshold, 255, 0
    )  # turns the flipped grayscale into binary for easier fill
...
def postprocess(
    ...
    """
    from anomaly_detectors.anomalib_lmi.v0.model import AnomalyModel as AnomalyModelV0
