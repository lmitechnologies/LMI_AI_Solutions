...
""" MODULE:
    ...
    USAGE:
        python3 get_local_hmaps.py --csv_in /my/csv/path/my_file.csv --data_path /my/data/path/ 
                                   --zmin -100 --zmax 100 --extra_str remove_this_part

    DESCRIPTION:
        Generates new local pointcloud surface (.png) from data file and csv containing bounding boxes.  
            The .csv file is generated by function: 
            fringeai_ml/object_detection/TensorFlow/utils/via_json_to_csv.py when used with images labeled with bounding boxes.  
            Currently does not support .csv files created from labeling data that includes mask regions.
"""


def gen_surface_and_save(
    pcd,
    x_ul,
    x_lr,
    y_ul,
    ...
    if color_option == "gray":
        ...
        pcd.convert_points_to_color_image(
            normalize=False,
            rgb_mapping="rainbow",
            ZMIN=zmin,
            ZMAX=zmax,
...
if __name__ == "__main__":
    ...
    ap.add_argument(
        ...
        "--csv_in",
        required=True,
        help="csv input file with fname, label, bounding box",
    )
    ...
    ap.add_argument(
        ...
        "--extra_str",
        default=None,
        help="extra string appended to image file used to locate point cloud.",
    )
