                ...
                if os.path.exists(filepath):
                    for j, _ in enumerate(regions):
                        ...
                        if render:
                            ...
                            if regions[j]["shape_attributes"]["name"] == "polygon" and (not mask_to_bbox):
                            ...
                            elif regions[j]["shape_attributes"]["name"] == "rect" or (
                                regions[j]["shape_attributes"]["name"] == "polygon" and mask_to_bbox
                            ):
                                image = cv2.rectangle(
                                    image,
                                    (x_ul, y_ul),
                                ...
                                cv2.putText(
                                    ...
                                    label,
                                    (
                                        cx - RADIUS - 2 * THICKNESS,
                                        cy - RADIUS - 2 * THICKNESS,
                                    ),
                                    cv2.FONT_HERSHEY_SIMPLEX,
                                    0.8,
                                    (0, 255, 0),
