                    ...
                    label_obj["regions"].append(
                        {
                            ...
                            "region_attributes": {"object": boxes["object"]},
                        }
                    )
                    ...
                    label_obj["regions"].append(
                        {
                            ...
                            "region_attributes": {"object": polygon["object"]},
                        }
                    )
    ...
    for key in files:
        if "image" in files[key].keys() and "labels" in files[key].keys():
            ...
            with open(files[key]["labels"], "r") as file:
                ...
                label_obj = {
                    "annotations": [{"result": []}],
                    "data": {"image": "gs://" + bucket + str(files[key]["image"]).split(Path(bucket).stem)[1]},
                }
                ...
                for polygons in label_json["polygons"]:
                    ...
                    polygon = {
                        ...
                        "original_height": height,
                        "image_rotation": 0,
                        "value": {"points": [], "polygonlabels": [polygons["object"]]},
                        "from_name": "polygon",
                        "to_name": "image",
                        "type": "polygonlabels",
                    }
