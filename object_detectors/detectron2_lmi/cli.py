...
if __name__ == "__main__":
    ...
    train_ap.add_argument(
        ...
        default=os.path.join("/home", DET2_CONFIG_FILE),
    )
    train_ap.add_argument(
        "--detectron2-config",
        type=str,
    ...
    test.add_argument(
        ...
        "--weights",
        type=str,
        default=os.path.join(DET2_DEFAULT_DIR, DET2_PT_EXPORT),
    ...
    convert_ap.add_argument(
        ...
        metavar="FILE",
        help="path to config file",
        default=os.path.join(DET2_DEFAULT_DIR, DET2_CONFIG_FILE),
    )
    convert_ap.add_argument(
        "-o",
        "--output",
        help="The output directory for the converted model",
        type=str,
        default=DET2_DEFAULT_DIR,
    )
    convert_ap.add_argument(
        "-w",
        "--weights",
        help="The Detectron 2 model weights (.pth)",
        type=str,
        default=os.path.join(DET2_DEFAULT_DIR, DET2_PTH_EXPORT),
    )
    convert_ap.add_argument(
        "-s",
        "--sample_image",
        ...
        type=str,
        default=os.path.join(DET2_DEFAULT_DIR, DET2_SAMPLE_IMAGE),
    )
