...
import numpy as np
import torch
import torchvision  # noqa: F401  ultralytics only takes its fused CUDA NMS kernel when this is already in sys.modules
...
from lmi_utils.image_utils.types import ImageLike, to_3channel
