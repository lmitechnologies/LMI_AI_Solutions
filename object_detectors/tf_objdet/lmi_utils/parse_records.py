...
class CustomParser(data_parser.DataToNumpyParser):
    ...
    def __init__(self, application_type="detection", allow_missing=False):
        ...
        if application_type == "detection":
            ...
            self.items_to_handlers[fields.InputDataFields.groundtruth_classes] = Int64Parser(fields.TfExampleFields.object_class_label)

        elif application_type == "segmentation":
            self.items_to_handlers[fields.InputDataFields.groundtruth_instance_masks] = StringParser(fields.TfExampleFields.instance_masks)
            ...
            self.items_to_handlers[fields.InputDataFields.groundtruth_image_classes] = Int64Parser(fields.TfExampleFields.image_class_label)
        else:
