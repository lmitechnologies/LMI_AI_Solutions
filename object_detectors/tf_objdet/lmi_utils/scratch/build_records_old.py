...
def main(_):
    ...
    try:
        ...
        print(
            "[INFO] Faster R-CNN by default since MASK_OPTION is not defined in ",
            args["config_path"],
        )
        MASK_OPTION = False
    try:
        ...
        print(
            "[INFO] No resizing because RESIZE_OPTION is not defined in ",
            args["config_path"],
        )
        RESIZE_OPTION = False
        ...
        for k in keys:
            ...
            if RESIZE_OPTION:
                try:
                    ...
                    print(
                        "[INFO] No resizing because MAX_W is not defined in ",
                        args["config_path"],
                    )
