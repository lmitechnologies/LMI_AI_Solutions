# TODO: Check to see if we can eliminate custom code

r"""
[Modified to support dynamic number of input images] - Yijun Jiang
...
flags.DEFINE_string(
    "input_type",
    "image_tensor",
    "Type of input node. Can be one of [`image_tensor`, `encoded_image_string_tensor`, `tf_example`, `float_image_tensor`]",
)
flags.DEFINE_string(
